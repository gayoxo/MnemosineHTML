...
<div class="zonIndex">
	...
	<p class="zonaIndexCentro_text">
        En <i>Mnemosine</i> podrá encontrar una base de datos enriquecida con enlaces a autores,
        obras, colecciones literarias y revistas de la llamada Edad de Plata de la literatura
        española (1868-1936) pertenecientes a un repertorio que es necesario rescatar desde el
    ...
    <p class="zonaIndexCentro_text">
        ...
        Biblioteca de la Universidad de <a class="zonaIndexCentro_text_link" href="https://oac.cdlib.org/findaid/ark:/13030/kt9t1nf91c/" target="_blank">California</a> y del Archivo del <a class="zonaIndexCentro_text_link" href="https://www.iai.spk-
        berlin.de/es/biblioteca/catalogos-y-bancos-de-datos.html" target="_blank">Instituto Iberoamericano de Berlín</a>. La Biblioteca Digital
        Mnemosine contiene, además, colecciones de datos y metadatos aportados por
