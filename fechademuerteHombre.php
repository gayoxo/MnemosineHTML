<script type="text/javascript">
	...
	{
		curl_close($curl);
		$service_url = $ServerService.'muertos3639hombre';
	...
	}else
	{
        ...
        var chart = new google.visualization.Histogram(document.getElementById('chart_div_H'));
          ...
          google.visualization.events.addListener(chart, 'select', function() {
              ...
              if (selection.length > 0) {
                  var seleccionIndex = selection[0].row;
                      ...
                      window.open("buscar_basico.php?q=genero:hombre AND fechademuerte:" + data.getValue(seleccionIndex, 1), "_blank");
...
<p class="estadisticasTitulo colecciones_desc">Hombres muertos entre 1936 y 1939 </p>
<div class="zonIndex" id="chart_div_H" style="height: 500px;"></div>
